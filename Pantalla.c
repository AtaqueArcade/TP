...
Imagen Pantalla_ImagenLee(char *fichero, int transparencia)
{
    ...
    if (transparencia)
    {
        ...
        else
        {
            ...
            {
            case 15:
                if (SDL_SetColorKey(surface, SDL_TRUE, (*(Uint16 *) surface->pixels) & 0x00007FFF)==-1) Pantalla_Error();
                break;
            case 16:
                if (SDL_SetColorKey(surface, SDL_TRUE, *(Uint16 *) surface->pixels)==-1) Pantalla_Error();
                break;
            case 24:
                if (SDL_SetColorKey(surface, SDL_TRUE, (*(Uint32 *) surface->pixels) & 0x00FFFFFF)==-1) Pantalla_Error();
                break;
            case 32:
                if (SDL_SetColorKey(surface, SDL_TRUE, *(Uint32 *) surface->pixels)==-1) Pantalla_Error();
                break;
            }
        }
    }
